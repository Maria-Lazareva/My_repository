...
kmday1 = int(input('Сколько пробежал в первый день? '))
kilom = int(input('Введите число километров: '))
day = 1
print(day, kmday1)
while kilom >= kmday1:
    kmday1 = 1.1 * kmday1
    day += 1
    print(day, kmday1)
result_str = f'На {day} день спортсмен достиг результата - не менее {kilom}км.'
print(result_str)
